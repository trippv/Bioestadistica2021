...
<select id="imgList">
  <option value="ggplot_test.png">Simple</option>
  <option value="ggPlot_classic.png">theme_classic()</option>
  <option value="ggPlot_minimal.png">theme_minimal()</option>
  <option value="ggPlot_dark.png">theme_dark()</option>
  <option value="ggPlot_light.png">theme_light()</option>
  <option value="ggPlot_void.png">theme_void()</option>
  <option value="ggPlot_bw.png">theme_bw()</option>
</select>
<img id="image" width="700" src="ggPlot_test.png" />
