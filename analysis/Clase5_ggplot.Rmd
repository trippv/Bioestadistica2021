...
<select id="imgList">
  <option value="./figure/ggplot_test.png">Simple</option>
  <option value="./figure/ggPlot_minimal.png">theme_minimal()</option>
  <option value="./figure/ggPlot_dark.png">theme_dark()</option>
  <option value="./figure/ggPlot_light.png">theme_ligh()</option>
  <option value="./figure/ggPlot_void.png">theme_void()</option>
  <option value="./figure/ggPlot_bw.png">theme_bw()</option>
</select>
<img id="image" width="700" src="./figure/ggPlot_test.png" />
