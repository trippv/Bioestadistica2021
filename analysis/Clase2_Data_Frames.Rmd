...
```{r}
tabla = read.table("data/crudos/Tabla1_Muestreo.txt", sep = "\t", header = TRUE)
```
...
Dentro de tu projecto, en la carpeta `data`hay cuatro archivos los cuales contienen los resultados de la actividad enzimatica de la lactado deshidrogenasa (_LDH_), citrato sintqasa (_CS_) y tauropina deshidrogenasa (_TDH_). Estas enzimas se analizaron en cuatro experimentos diferentes (Experimento1, Experimento2, Experimento3 y Experimento4).
...
3. Filtra todas las mediciones con _Meas_Temp_ igual a 18°C
